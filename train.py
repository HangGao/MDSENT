...
parser.add_argument('-b', '--batch', action='store_const', const=10, help='batch size. Default:10')
parser.add_argument('-e', '--epoch', action='store_const', const=10, help='number of epochs')
